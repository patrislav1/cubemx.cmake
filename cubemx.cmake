...
define_property(TARGET PROPERTY SOURCE_FILE_LINKER
...
function(add_startup)
    ...
    set(SOURCE_FILE_STARTUP ${CMX_STARTUP} PARENT_SCOPE)
endfunction()
...
function(add_ldscript)
    ...
    set(SOURCE_FILE_LINKER ${CMX_LDSCRIPT} PARENT_SCOPE)
endfunction()
...
function(cubemx_target)
    ...
    set_property(TARGET ${CMX_TARGET} PROPERTY TARGET_FILE_BIN "${CMX_TARGET}.bin")
